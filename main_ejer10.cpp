...
void display(void)   // Creamos la funcion donde se dibuja
{
	...
	pintaTexto(-12, 12.0, -14.0, (void *)font, "Ejercicio Casa 10");
	pintaTexto(-12, 10.5, -14, (void *)font, "Helicoptero en Movimiento");
	glColor3f(1.0, 1.0, 1.0);
	glEnable(GL_LIGHTING);
	glEnable(GL_TEXTURE_2D);
...
int main(int argc, char** argv)   // Main Function
{
	...
	glutCreateWindow("Ejercicio Casa 10"); // Nombre de la Ventana
